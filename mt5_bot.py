...
TELEGRAM_TOKEN = "8216500088:AAG_B14hLVqCM-bXCj7nhHCTBgXGZzIKKlo" 
...
"
        "**ការព្រមាន៖** នេះជាការទស្សន៍ទាយដោយ Bot ហើយអាចមានកំហុស។ "
        "សូមប្រើការវិភាគផ្ទាល់ខ្លួនមុនពេលធ្វើការជួញដូរ។"
    )
